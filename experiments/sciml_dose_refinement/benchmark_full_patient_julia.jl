...
function main()
    ...
    # Just initialize randomly for speed benchmarking
    ...
    println("Benchmarking full patient sliding window (Julia SciML)...")
    GC.gc()
    CUDA.reclaim()
    ...
    println("Full Patient Inference Time (Julia SciML): ", round(t1 - t0, digits=2), " seconds")
end
